# SannySynth - Complete Documentation

[![Automated builds](https://github.com/taellinglin/SannySynth3/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/taellinglin/SannySynth3/actions/workflows/build.yml?query=branch%3Amaster)
[![Tests](https://github.com/taellinglin/SannySynth3/actions/workflows/test.yml/badge.svg?branch=master)](https://github.com/taellinglin/SannySynth3/actions/workflows/test.yml?query=branch%3Amaster)
[![Documentation](https://github.com/taellinglin/SannySynth3/actions/workflows/docs.yml/badge.svg?branch=master)](https://github.com/taellinglin/SannySynth3/actions/workflows/docs.yml?query=branch%3Amaster)

---

## Overview

**SannySynth** is a powerful subtractive synthesizer implemented as a VST3/CLAP plugin, built with the NIH-plug framework. It combines classic synthesis techniques with modern workflow, offering comprehensive sound design capabilities for electronic music production and sound design.
...
#### Windows
1. Download the latest release from the [Releases page](https://github.com/taellinglin/SannySynth3/releases)
2. Extract the archive
3. Copy `SannySynth.vst3` folder to: `C:\Program Files\Common Files\VST3\`
4. Copy `SannySynth.clap` file to: `C:\Program Files\Common Files\CLAP\`
...
4. Copy `SannySynth.vst3` to: `~/Library/Audio/Plug-Ins/VST3`
5. Copy `SannySynth.clap` to: `~/Library/Audio/Plug-Ins/CLAP`
6. Restart your DAW
...
2. Extract and copy files:
   ```bash
   mkdir -p ~/.vst3 ~/.clap
   cp -r SannySynth.vst3 ~/.vst3/
   cp SannySynth.clap ~/.clap/
   chmod +x ~/.vst3/SannySynth.vst3/Contents/x86_64-linux/SannySynth.so
   chmod +x ~/.clap/SannySynth.clap
   ```
...
git clone https://github.com/taellinglin/SannySynth3.git
cd SannySynth3

# Build release version
cargo xtask bundle sannysynth --release
```

The compiled plugins will be located in `target/bundled/`:
- `SannySynth.vst3` - VST3 plugin
- `SannySynth.clap` - CLAP plugin

### Development Build

```bash
# Build debug version (faster compilation, slower runtime)
cargo xtask bundle sannysynth
...
SannySynth features a clean, organized interface using the custom **zCool XiaoWei** font for enhanced readability.
...
- Verify bundle is not quarantined: `xattr -d com.apple.quarantine SannySynth.vst3`

**Linux:**
- Check file permissions (chmod +x)
- Verify shared library dependencies: `ldd SannySynth.so`
...
```
SannySynth3/
├── plugins/SannySynth/     # Main plugin code
│   └── src/
...
- **GitHub Repository**: https://github.com/taellinglin/SannySynth3
- **Issues/Bug Reports**: https://github.com/taellinglin/SannySynth3/issues
...
*Documentation generated for SannySynth v0.1.0*
