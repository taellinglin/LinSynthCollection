...
use filter::{Filter, FilterStyle, FilterType};
use limiter::Limiter;
use multi_filter::MultiStageFilter;
use preset_bank::{program_list, GM_PROGRAM_NAMES};
use resonator::{ResonatorBank, ResonatorTimbre};
...
struct SubSynthParams {
    ...
    #[id = "filter_style"]
    filter_style: EnumParam<FilterStyle>,
    #[id = "filter_drive"]
    filter_vintage_drive: FloatParam,
    #[id = "filter_curve"]
    filter_vintage_curve: FloatParam,
    #[id = "filter_mix"]
    filter_vintage_mix: FloatParam,
    #[id = "filter_trim"]
    filter_vintage_trim: FloatParam,
    #[id = "filter_cut"]
    ...
    #[id = "res_en"]
    resonator_enable: BoolParam,
    #[id = "res_mix"]
    resonator_mix: FloatParam,
    #[id = "res_tone"]
    resonator_tone: FloatParam,
    #[id = "res_shape"]
    resonator_shape: FloatParam,
    #[id = "res_map"]
    resonator_timbre: EnumParam<ResonatorTimbre>,
    #[id = "res_damp"]
    resonator_damping: FloatParam,
    #[id = "mf_en"]
    ...
    #[id = "mf_a_style"]
    multi_filter_a_style: EnumParam<FilterStyle>,
    #[id = "mf_a_drive"]
    multi_filter_a_drive: FloatParam,
    #[id = "mf_a_curve"]
    multi_filter_a_curve: FloatParam,
    #[id = "mf_a_mix"]
    multi_filter_a_mix: FloatParam,
    #[id = "mf_a_trim"]
    multi_filter_a_trim: FloatParam,
    #[id = "mf_a_cut"]
    ...
    #[id = "mf_b_style"]
    multi_filter_b_style: EnumParam<FilterStyle>,
    #[id = "mf_b_drive"]
    multi_filter_b_drive: FloatParam,
    #[id = "mf_b_curve"]
    multi_filter_b_curve: FloatParam,
    #[id = "mf_b_mix"]
    multi_filter_b_mix: FloatParam,
    #[id = "mf_b_trim"]
    multi_filter_b_trim: FloatParam,
    #[id = "mf_b_cut"]
    ...
    #[id = "mf_c_style"]
    multi_filter_c_style: EnumParam<FilterStyle>,
    #[id = "mf_c_drive"]
    multi_filter_c_drive: FloatParam,
    #[id = "mf_c_curve"]
    multi_filter_c_curve: FloatParam,
    #[id = "mf_c_mix"]
    multi_filter_c_mix: FloatParam,
    #[id = "mf_c_trim"]
    multi_filter_c_trim: FloatParam,
    #[id = "mf_c_cut"]
...
impl Default for SubSynthParams {
    fn default() -> Self {
        Self {
            ...
            chorus_enable: BoolParam::new("Chorus Enable", true),
            ...
            .with_step_size(0.01),
            resonator_tone: FloatParam::new(
                "Resonator Tone",
                0.6,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            .with_step_size(0.01),
            resonator_shape: FloatParam::new(
                "Resonator Shape",
                0.5,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            ...
            resonator_damping: FloatParam::new(
                "Resonator Damping",
                0.2,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            ...
            multi_filter_a_style: EnumParam::new("Multi Filter A Style", FilterStyle::Digital),
            multi_filter_a_drive: FloatParam::new(
                "Multi Filter A Drive",
                0.35,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            .with_step_size(0.01),
            multi_filter_a_curve: FloatParam::new(
                "Multi Filter A Curve",
                0.5,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            .with_step_size(0.01),
            multi_filter_a_mix: FloatParam::new(
                "Multi Filter A Mix",
                1.0,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            .with_step_size(0.01),
            multi_filter_a_trim: FloatParam::new(
                "Multi Filter A Trim",
                1.0,
                FloatRange::Linear { min: 0.5, max: 1.5 },
            )
            ...
            multi_filter_b_style: EnumParam::new("Multi Filter B Style", FilterStyle::Digital),
            multi_filter_b_drive: FloatParam::new(
                "Multi Filter B Drive",
                0.35,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            .with_step_size(0.01),
            multi_filter_b_curve: FloatParam::new(
                "Multi Filter B Curve",
                0.5,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            .with_step_size(0.01),
            multi_filter_b_mix: FloatParam::new(
                "Multi Filter B Mix",
                1.0,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            .with_step_size(0.01),
            multi_filter_b_trim: FloatParam::new(
                "Multi Filter B Trim",
                1.0,
                FloatRange::Linear { min: 0.5, max: 1.5 },
            )
            ...
            multi_filter_c_style: EnumParam::new("Multi Filter C Style", FilterStyle::Digital),
            multi_filter_c_drive: FloatParam::new(
                "Multi Filter C Drive",
                0.35,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            .with_step_size(0.01),
            multi_filter_c_curve: FloatParam::new(
                "Multi Filter C Curve",
                0.5,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            .with_step_size(0.01),
            multi_filter_c_mix: FloatParam::new(
                "Multi Filter C Mix",
                1.0,
                FloatRange::Linear { min: 0.0, max: 1.0 },
            )
            .with_step_size(0.01),
            multi_filter_c_trim: FloatParam::new(
                "Multi Filter C Trim",
                1.0,
                FloatRange::Linear { min: 0.5, max: 1.5 },
            )
...
impl Plugin for SubSynth {
    ...
    fn program_list(&self) -> Option<ProgramList> {
        Some(program_list(&self.params))
    }
    ...
    fn process(
        ...
        while block_start < num_samples {
            ...
            for (value_idx, sample_idx) in (block_start..block_end).enumerate() {
                ...
                for voice in self.voices.iter_mut() {
                    if let Some(voice) = voice {
                        ...
                        let _vib_rate: f32 = self.params.vibrato_rate.value();
                        ...
                        let mut apply_mod = |source: ModSource, target: ModTarget, amount: f32| {
                        ...
                        let classic_sample = generate_waveform(waveform, voice.phase);
                        ...
                        let wavetable_sample =
                            wavetable_bank.sample(voice.phase, wavetable_position);
                        ...
                        if sub_level > 0.0 {
                            let sub_phase = (voice.phase * 0.5).fract();
                            let sub_sample =
                        ...
                        let filter_vintage_drive = self.params.filter_vintage_drive.value();
                        let filter_vintage_curve = self.params.filter_vintage_curve.value();
                        let filter_vintage_mix = self.params.filter_vintage_mix.value();
                        let filter_vintage_trim = self.params.filter_vintage_trim.value();
                        let filtered_sample = match voice.filter.unwrap_or(FilterType::None) {
                            ...
                            FilterType::Lowpass => {
                                ...
                                voice.lowpass_filter.set_style(filter_style);
                                voice.lowpass_filter.set_vintage_drive(filter_vintage_drive);
                                voice.lowpass_filter.set_vintage_curve(filter_vintage_curve);
                                voice.lowpass_filter.set_vintage_mix(filter_vintage_mix);
                                voice.lowpass_filter.set_vintage_trim(filter_vintage_trim);
                            ...
                            FilterType::Highpass => {
                                ...
                                voice.highpass_filter.set_style(filter_style);
                                voice.highpass_filter.set_vintage_drive(filter_vintage_drive);
                                voice.highpass_filter.set_vintage_curve(filter_vintage_curve);
                                voice.highpass_filter.set_vintage_mix(filter_vintage_mix);
                                voice.highpass_filter.set_vintage_trim(filter_vintage_trim);
                            ...
                            FilterType::Bandpass => {
                                ...
                                voice.bandpass_filter.set_style(filter_style);
                                voice.bandpass_filter.set_vintage_drive(filter_vintage_drive);
                                voice.bandpass_filter.set_vintage_curve(filter_vintage_curve);
                                voice.bandpass_filter.set_vintage_mix(filter_vintage_mix);
                                voice.bandpass_filter.set_vintage_trim(filter_vintage_trim);
                            ...
                            FilterType::Notch => {
                                ...
                                voice.notch_filter.set_style(filter_style);
                                voice.notch_filter.set_vintage_drive(filter_vintage_drive);
                                voice.notch_filter.set_vintage_curve(filter_vintage_curve);
                                voice.notch_filter.set_vintage_mix(filter_vintage_mix);
                                voice.notch_filter.set_vintage_trim(filter_vintage_trim);
                            ...
                            FilterType::Statevariable => {
                                ...
                                voice.statevariable_filter.set_style(filter_style);
                                voice.statevariable_filter.set_vintage_drive(filter_vintage_drive);
                                voice.statevariable_filter.set_vintage_curve(filter_vintage_curve);
                                voice.statevariable_filter.set_vintage_mix(filter_vintage_mix);
                                voice.statevariable_filter.set_vintage_trim(filter_vintage_trim);
                        ...
                        let mut final_sample =
                            generated_sample * (1.0 - filter_amount) + filtered_sample * filter_amount;

                        if self.params.resonator_enable.value() {
                            let mix = self.params.resonator_mix.value().clamp(0.0, 1.0);
                            if mix > 0.0 {
                                let base_freq = util::midi_note_to_freq(voice.note)
                                    * (2.0_f32).powf(voice.tuning / 12.0);
                                voice.resonator.set_sample_rate(sample_rate);
                                voice.resonator.set_base_freq(base_freq);
                                voice.resonator
                                    .set_tone(self.params.resonator_tone.value());
                                voice.resonator
                                    .set_shape(self.params.resonator_shape.value());
                                voice.resonator
                                    .set_timbre(self.params.resonator_timbre.value());
                                voice.resonator
                                    .set_damping(self.params.resonator_damping.value());
                                let resonated = voice.resonator.process(final_sample);
                        ...
                        let processed_left_sample = left_amp * dc_blocked_sample;
                        let processed_right_sample = right_amp * dc_blocked_sample;
                        ...
                        // Update voice phase
                        voice.phase += drifted_phase_delta;
                        if voice.phase >= 1.0 {
                            voice.phase -= 1.0;
                        }
                    }
            ...
            if self.params.multi_filter_enable.value() {
                ...
                let a_style = self.params.multi_filter_a_style.value();
                let b_style = self.params.multi_filter_b_style.value();
                let c_style = self.params.multi_filter_c_style.value();
                let a_drive = self.params.multi_filter_a_drive.value();
                let b_drive = self.params.multi_filter_b_drive.value();
                let c_drive = self.params.multi_filter_c_drive.value();
                let a_curve = self.params.multi_filter_a_curve.value();
                let b_curve = self.params.multi_filter_b_curve.value();
                let c_curve = self.params.multi_filter_c_curve.value();
                let a_mix = self.params.multi_filter_a_mix.value();
                let b_mix = self.params.multi_filter_b_mix.value();
                let c_mix = self.params.multi_filter_c_mix.value();
                let a_trim = self.params.multi_filter_a_trim.value();
                let b_trim = self.params.multi_filter_b_trim.value();
                let c_trim = self.params.multi_filter_c_trim.value();
...
impl SubSynth {
    ...
    fn find_or_create_voice(
        ...
        tuning: f32,
        vibrato: f32,
        _amp_envelope: ADSREnvelope,
        _filter_cut_envelope: ADSREnvelope,
        _filter_res_envelope: ADSREnvelope,
        vib_mod: Modulator,
        trem_mod: Modulator,
    ) -> &mut Voice {
        ...
        let mut new_voice = Voice {
            ...
            drift_offset: 0.0,
            resonator: ResonatorBank::new(self.sample_rate, util::midi_note_to_freq(note)),
        };
...
impl ClapPlugin for SubSynth {
    ...
    const CLAP_DESCRIPTION: Option<&'static str> =
        Some("A modular wavetable synth for evolving ambient textures");
