# FishSynth - Complete Documentation

[![Automated builds](https://github.com/taellinglin/FishSynth/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/taellinglin/FishSynth/actions/workflows/build.yml?query=branch%3Amaster)
[![Tests](https://github.com/taellinglin/FishSynth/actions/workflows/test.yml/badge.svg?branch=master)](https://github.com/taellinglin/FishSynth/actions/workflows/test.yml?query=branch%3Amaster)
[![Documentation](https://github.com/taellinglin/FishSynth/actions/workflows/docs.yml/badge.svg?branch=master)](https://github.com/taellinglin/FishSynth/actions/workflows/docs.yml?query=branch%3Amaster)

---

## Overview

**FishSynth** is a powerful subtractive synthesizer implemented as a VST3/CLAP plugin, built with the NIH-plug framework. It combines classic synthesis techniques with modern workflow, offering comprehensive sound design capabilities for electronic music production and sound design.
...
#### Windows
1. Download the latest release from the [Releases page](https://github.com/taellinglin/FishSynth/releases)
2. Extract the archive
3. Copy `FishSynth.vst3` folder to: `C:\Program Files\Common Files\VST3\`
4. Copy `FishSynth.clap` file to: `C:\Program Files\Common Files\CLAP\`
...
4. Copy `FishSynth.vst3` to: `~/Library/Audio/Plug-Ins/VST3`
5. Copy `FishSynth.clap` to: `~/Library/Audio/Plug-Ins/CLAP`
6. Restart your DAW
...
2. Extract and copy files:
   ```bash
   mkdir -p ~/.vst3 ~/.clap
   cp -r FishSynth.vst3 ~/.vst3/
   cp FishSynth.clap ~/.clap/
   chmod +x ~/.vst3/FishSynth.vst3/Contents/x86_64-linux/FishSynth.so
   chmod +x ~/.clap/FishSynth.clap
   ```
...
git clone https://github.com/taellinglin/FishSynth.git
cd FishSynth

# Build release version
cargo xtask bundle fishsynth --release
```

The compiled plugins will be located in `target/bundled/`:
- `FishSynth.vst3` - VST3 plugin
- `FishSynth.clap` - CLAP plugin

### Development Build

```bash
# Build debug version (faster compilation, slower runtime)
cargo xtask bundle fishsynth
...
FishSynth features a clean, organized interface using the custom **zCool XiaoWei** font for enhanced readability.
...
- Verify bundle is not quarantined: `xattr -d com.apple.quarantine FishSynth.vst3`

**Linux:**
- Check file permissions (chmod +x)
- Verify shared library dependencies: `ldd FishSynth.so`
...
```
FishSynth/
├── plugins/FishSynth/     # Main plugin code
│   └── src/
...
- **GitHub Repository**: https://github.com/taellinglin/FishSynth
- **Issues/Bug Reports**: https://github.com/taellinglin/FishSynth/issues
...
*Documentation generated for FishSynth v0.1.0*
