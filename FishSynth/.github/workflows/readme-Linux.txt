FishSynth - Installation Instructions for Linux
===============================================

Thank you for downloading FishSynth!

VST3 Plugin Installation:
--------------------------
1. Copy the FishSynth.vst3 DIRECTORY to:
   ~/.vst3
...
--------------------------
1. Copy the FishSynth.clap FILE to:
   ~/.clap
...
https://github.com/taellinglin/FishSynth
