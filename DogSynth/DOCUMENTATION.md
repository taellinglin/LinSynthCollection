# DogSynth - Complete Documentation

[![Automated builds](https://github.com/taellinglin/DogSynth/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/taellinglin/DogSynth/actions/workflows/build.yml?query=branch%3Amaster)
[![Tests](https://github.com/taellinglin/DogSynth/actions/workflows/test.yml/badge.svg?branch=master)](https://github.com/taellinglin/DogSynth/actions/workflows/test.yml?query=branch%3Amaster)
[![Documentation](https://github.com/taellinglin/DogSynth/actions/workflows/docs.yml/badge.svg?branch=master)](https://github.com/taellinglin/DogSynth/actions/workflows/docs.yml?query=branch%3Amaster)

---

## Overview

**DogSynth** is a knitty gritty wavetable bass synthesizer implemented as a VST3/CLAP plugin, built with the NIH-plug framework. It blends aggressive modulation, sub layering, and wavetable distortion to deliver dubstep-ready bass and heavy electronic sound design.
...
#### Windows
1. Download the latest release from the [Releases page](https://github.com/taellinglin/DogSynth/releases)
2. Extract the archive
3. Copy `DogSynth.vst3` folder to: `C:\Program Files\Common Files\VST3\`
4. Copy `DogSynth.clap` file to: `C:\Program Files\Common Files\CLAP\`
...
4. Copy `DogSynth.vst3` to: `~/Library/Audio/Plug-Ins/VST3`
5. Copy `DogSynth.clap` to: `~/Library/Audio/Plug-Ins/CLAP`
6. Restart your DAW
...
2. Extract and copy files:
   ```bash
   mkdir -p ~/.vst3 ~/.clap
   cp -r DogSynth.vst3 ~/.vst3/
   cp DogSynth.clap ~/.clap/
   chmod +x ~/.vst3/DogSynth.vst3/Contents/x86_64-linux/DogSynth.so
   chmod +x ~/.clap/DogSynth.clap
   ```
...
git clone https://github.com/taellinglin/DogSynth.git
cd DogSynth

# Build release version
cargo xtask bundle dogsynth --release
```

The compiled plugins will be located in `target/bundled/`:
- `DogSynth.vst3` - VST3 plugin
- `DogSynth.clap` - CLAP plugin

### Development Build

```bash
# Build debug version (faster compilation, slower runtime)
cargo xtask bundle dogsynth
...
DogSynth features a clean, organized interface using the custom **zCool XiaoWei** font for enhanced readability.
...
- Verify bundle is not quarantined: `xattr -d com.apple.quarantine DogSynth.vst3`

**Linux:**
- Check file permissions (chmod +x)
- Verify shared library dependencies: `ldd DogSynth.so`
...
```
DogSynth/
├── plugins/dogsynth/     # Main plugin code
│   └── src/
...
- **GitHub Repository**: https://github.com/taellinglin/DogSynth
- **Issues/Bug Reports**: https://github.com/taellinglin/DogSynth/issues
...
*Documentation generated for DogSynth v0.1.0*
