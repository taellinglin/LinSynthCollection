...
impl BoolParam {
    ...
    /// Set the plain, unnormalized value without notifying the host.
    pub fn set_plain_value(&self, plain: bool) -> bool {
        ParamMut::set_plain_value(self, plain)
    }

    /// Set a normalized value without notifying the host.
    pub fn set_normalized_value(&self, normalized: f32) -> bool {
        ParamMut::set_normalized_value(self, normalized)
    }
}
