...
pub(crate) struct Voice {
    ...
    pub(crate) sizzle_osc_lp: Biquad,
    pub(crate) sizzle_wt_lp: Biquad,
    pub(crate) alias_lp1: Biquad,
    pub(crate) alias_lp2: Biquad,
    pub(crate) tight_lp: Biquad,
    pub(crate) tight_hp: Biquad,
    pub(crate) ring_phase: f32,
}
