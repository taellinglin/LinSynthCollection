# CatSynth - Complete Documentation

[![Automated builds](https://github.com/taellinglin/CatSynth/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/taellinglin/CatSynth/actions/workflows/build.yml?query=branch%3Amaster)
[![Tests](https://github.com/taellinglin/CatSynth/actions/workflows/test.yml/badge.svg?branch=master)](https://github.com/taellinglin/CatSynth/actions/workflows/test.yml?query=branch%3Amaster)
[![Documentation](https://github.com/taellinglin/CatSynth/actions/workflows/docs.yml/badge.svg?branch=master)](https://github.com/taellinglin/CatSynth/actions/workflows/docs.yml?query=branch%3Amaster)

---

## Overview

**CatSynth** is a knitty gritty wavetable bass synthesizer implemented as a VST3/CLAP plugin, built with the NIH-plug framework. It blends aggressive modulation, sub layering, and wavetable distortion to deliver dubstep-ready bass and heavy electronic sound design.
...
#### Windows
1. Download the latest release from the [Releases page](https://github.com/taellinglin/CatSynth/releases)
2. Extract the archive
3. Copy `CatSynth.vst3` folder to: `C:\Program Files\Common Files\VST3\`
4. Copy `CatSynth.clap` file to: `C:\Program Files\Common Files\CLAP\`
...
4. Copy `CatSynth.vst3` to: `~/Library/Audio/Plug-Ins/VST3`
5. Copy `CatSynth.clap` to: `~/Library/Audio/Plug-Ins/CLAP`
6. Restart your DAW
...
2. Extract and copy files:
   ```bash
   mkdir -p ~/.vst3 ~/.clap
   cp -r CatSynth.vst3 ~/.vst3/
   cp CatSynth.clap ~/.clap/
   chmod +x ~/.vst3/CatSynth.vst3/Contents/x86_64-linux/CatSynth.so
   chmod +x ~/.clap/CatSynth.clap
   ```
...
git clone https://github.com/taellinglin/CatSynth.git
cd CatSynth

# Build release version
cargo xtask bundle CatSynth --release
```

The compiled plugins will be located in `target/bundled/`:
- `CatSynth.vst3` - VST3 plugin
- `CatSynth.clap` - CLAP plugin

### Development Build

```bash
# Build debug version (faster compilation, slower runtime)
cargo xtask bundle CatSynth
...
CatSynth features a clean, organized interface using the custom **zCool XiaoWei** font for enhanced readability.
...
- Verify bundle is not quarantined: `xattr -d com.apple.quarantine CatSynth.vst3`

**Linux:**
- Check file permissions (chmod +x)
- Verify shared library dependencies: `ldd CatSynth.so`
...
```
CatSynth/
├── plugins/CatSynth/     # Main plugin code
│   └── src/
...
- **GitHub Repository**: https://github.com/taellinglin/CatSynth
- **Issues/Bug Reports**: https://github.com/taellinglin/CatSynth/issues
...
*Documentation generated for CatSynth v0.1.0*
