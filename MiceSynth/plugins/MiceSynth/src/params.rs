...
pub(crate) struct SubSynthParams {
    ...
    #[persist = "morph_a"]
    pub(crate) morph_a_snapshot: Arc<RwLock<Option<String>>>,
    #[persist = "morph_b"]
    pub(crate) morph_b_snapshot: Arc<RwLock<Option<String>>>,
    #[id = "preset"]
    ...
    #[id = "add_mix"]
    pub(crate) additive_mix: FloatParam,
    #[id = "add_partials"]
    pub(crate) additive_partials: FloatParam,
    #[id = "add_tilt"]
    pub(crate) additive_tilt: FloatParam,
    #[id = "add_inharm"]
    pub(crate) additive_inharm: FloatParam,
    #[id = "add_morph"]
    pub(crate) additive_morph: FloatParam,
    #[id = "add_decay"]
    pub(crate) additive_decay: FloatParam,
    #[id = "add_drift"]
    pub(crate) additive_drift: FloatParam,
    #[id = "wt_custom"]
    ...
    #[id = "morph_amt"]
    pub(crate) morph_amount: FloatParam,
    #[id = "vel_add"]
    pub(crate) vel_additive_amount: FloatParam,
    #[id = "breath_en"]
    pub(crate) breath_enable: BoolParam,
    #[id = "breath_amt"]
    pub(crate) breath_amount: FloatParam,
    #[id = "breath_atk"]
    pub(crate) breath_attack_ms: FloatParam,
    #[id = "breath_dec"]
    pub(crate) breath_decay_ms: FloatParam,
    #[id = "breath_tone"]
    pub(crate) breath_tone: FloatParam,
    #[id = "sub_level"]
